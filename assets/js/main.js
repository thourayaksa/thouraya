(function($) {
  ...
  function scrollFunction() {
    ...
    if (scroll >= 10) {
      $(".custom-logo").attr("src", "/assets/Logo/UntitlWAITed-1.png");
      $(".site-header").addClass("small-height");
    } else {
      
      $(".custom-logo").attr("src", "/assets/Logo/Untitled-1SA.png");
  ...
  function scrollAnimation() {
    $(
      "a:not(.portfolio-filter ul li a):not(.portfolio-item .item-inner):not(.nav-tabs a)"
  ...
  function sectionActive() {
    ...
    $('[data-spy="scroll"]').on("activate.bs.scrollspy", function() {
      console.log('activating scrtooll');
    ...
    $("#cf #submit").on("click", function() {
      ...
      if (!regex.test(email)) {
        $("#cf-msg")
          .fadeIn()
          .html(
            '<div class="alert alert-danger"><strong>Warning!</strong> Please Enter Valied Email.</div>'
          );
        return false;
      }
